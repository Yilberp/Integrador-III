...
import { EditNew } from "../Admin/FormNews/EditNew";
import { DeleteNew } from "./FormNews/DeleteNew";
import { EditSlider } from "./FormNews/EditSlider";
    ...
    return (
        <div className="w-5/6 absolute top-0 right-0 flex items-center justify-center min-h-screen">
            <form className="rounded-xl shadow-2xl p-8">
                <h4 className="text-2xl mb-4">Registrar Noticia</h4>
                <div className="flex">
                ...
                <button className="bg-red-500 hover:bg-red-700 text-white px-4 py-2 rounded-lg border-0">Registrar</button>
            </form>
        </div>
    )
}
